        ...
        <v-row dense>
            <v-col cols="12">
                <v-tabs v-model="tab">
                    ...
                    <v-tab key="supplemental" v-if="branch && branch.supplemental_files">{{$tc('Supplemental Files')}}</v-tab>
                </v-tabs>
                <v-tabs-items v-model="tab" class="fullWidth">
                    ...
                    <v-tab-item key="supplemental" v-if="branch && branch.supplemental_files">

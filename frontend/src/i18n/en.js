export default {
    en: {
        ...
        "References / Research that uses data": "References to research that uses this data",
        "Keywords": "Keywords",
        "Hyperlink to more information": "URL",
        ...
        "Version Description": "Edition Notes",
        ...
        "help.dataset.sector": "Business area data relates to (e.g. education, health, housing, immigration, income/work, justice, social",
        "help.dataset.data_type": "Type of source of the data (i.e. administrative, survey, aggregate, etc.)",
        "help.dataset.data_collection_type": "Is this dataset part of Main, Reserved or Restricted DI Program's collection",
        "help.dataset.restrictions_comments": "Specify any restrictions applying to the availability of this dataset",
        ...
        "help.dataset.contact": "Contact information for the data provider approver - include name, email address, phone#",
        "help.dataset.contact[0].name": "The contacts name",
        "help.dataset.contact[0].email": "The contacts email address",
        ...
        "help.edition.type": "Is this a standard or unmasked edition",
        "help.edition.description": "Notes about this edition. E.g. reason new addition was created, changes from previous edition, specify unmasked fields, specify availability of an unmasked edition",
        ...
        "help.edition.keywords": "Keywords describing the data",
        "help.edition.citation": "DI Program's recommended citation format",
        "help.edition.lifecycle": "Final disposition comments and date for an edition",
        "help.edition.collectionMethod": "What was the method used for collecting the data (e.g. paper survey with manual transcription of results into digital form)",
        "help.edition.faq": "Questions and answers about the data received by the research projects",
        "help.edition.published": "When checked, a public link to edition is created.",
        "help.edition.approved": "When checked, editing is locked.",
        "help.edition.references": "Refers to published studies using this data.",
        "help.edition.more_information[0].url": "URL of the web asset(s)",
        "help.edition.more_information[0].name": "Name of the web stored additional information",
        "help.edition.lifecycle.date": "Final disposition date for an edition",
        "help.edition.lifecycle.comment": "Final disposition comment for an edition",
        "help.edition.instructions": "Data Provider's instructions regarding linkage of data.",
        "help.edition.delta_over_time": "Changes to the data. E.g. new collection method introduced, policy or definition changes  affecting the data, etc.",
        "help.edition.additional_info": "Any other additional information about this data",
        "help.edition.linking_summary": "High level linkage summary from the linking report",
        "help.edition.processing_summary": "Summary of lessons learned from the ingestion processing (e.g. resolved data issues).",

...
module.exports = {
	sematically_classify_field: function(field_name, field_values, dt, debug = false) {
		return sematically_classify_field(field_name, field_values, dt, debug);
	}
};

function sematically_classify_field(field_name, field_values, dt, debug = false) {
